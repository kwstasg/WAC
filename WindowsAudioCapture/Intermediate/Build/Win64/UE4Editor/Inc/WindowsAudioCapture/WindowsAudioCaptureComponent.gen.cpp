...
// End Cross Module References
	...
	UFunction* Z_Construct_UFunction_UWindowsAudioCaptureComponent_BP_GetAverageBassValue()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("BP_GetAverageBassValue"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), nullptr, (EFunctionFlags)0x14422401, 65535, sizeof(WindowsAudioCaptureComponent_eventBP_GetAverageBassValue_Parms));
	...
	UFunction* Z_Construct_UFunction_UWindowsAudioCaptureComponent_BP_GetAverageFrequencyValueInRange()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("BP_GetAverageFrequencyValueInRange"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), nullptr, (EFunctionFlags)0x14422401, 65535, sizeof(WindowsAudioCaptureComponent_eventBP_GetAverageFrequencyValueInRange_Parms));
	...
	UFunction* Z_Construct_UFunction_UWindowsAudioCaptureComponent_BP_GetAverageSubBassValue()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("BP_GetAverageSubBassValue"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), nullptr, (EFunctionFlags)0x14422401, 65535, sizeof(WindowsAudioCaptureComponent_eventBP_GetAverageSubBassValue_Parms));
	...
	UFunction* Z_Construct_UFunction_UWindowsAudioCaptureComponent_BP_GetFrequencyArray()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("BP_GetFrequencyArray"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), nullptr, (EFunctionFlags)0x04022401, 65535, sizeof(WindowsAudioCaptureComponent_eventBP_GetFrequencyArray_Parms));
	...
	UFunction* Z_Construct_UFunction_UWindowsAudioCaptureComponent_BP_GetSpecificFrequencyValue()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("BP_GetSpecificFrequencyValue"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), nullptr, (EFunctionFlags)0x14422401, 65535, sizeof(WindowsAudioCaptureComponent_eventBP_GetSpecificFrequencyValue_Parms));
	...
	UClass* Z_Construct_UClass_UWindowsAudioCaptureComponent()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UWindowsAudioCaptureComponent_BP_GetAverageBassValue(), "BP_GetAverageBassValue"); // 1734328654
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UWindowsAudioCaptureComponent_BP_GetAverageFrequencyValueInRange(), "BP_GetAverageFrequencyValueInRange"); // 2391372683
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UWindowsAudioCaptureComponent_BP_GetAverageSubBassValue(), "BP_GetAverageSubBassValue"); // 4022041835
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UWindowsAudioCaptureComponent_BP_GetFrequencyArray(), "BP_GetFrequencyArray"); // 1654163812
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UWindowsAudioCaptureComponent_BP_GetSpecificFrequencyValue(), "BP_GetSpecificFrequencyValue"); // 995746970
	...
	IMPLEMENT_CLASS(UWindowsAudioCaptureComponent, 3690408990);
